<div class="flex justify-between items-center">
    ...
    <button type="button" onclick="my_modal_4.showModal()" class="text-white bg-[#2596be] hover:bg-[#2595beb6] focus:ring-4 focus:ring-[#234664] font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"><i class="fa-solid fa-plus"></i>&nbsp;Ajouter cargaison</button>
</div>
...
<div class="flex">
    ...
    <div class="flex gap-2 mt-6">
        <div class="relative">
            <input class="h-12 w-64 rounded-2 outline-none pl-8 border border-[#2596be]" type="text" id="cargo-code-search" placeholder="Filtrer par identifiant">
            <div class="absolute top-3 left-3">
                <i class="fa-solid fa-magnifying-glass text-gray-400"></i>
            </div>
        </div>
        <div class="relative">
            <input class="h-12 w-80 rounded-2 outline-none pl-8 border border-[#2596be]" type="text" id="departure-point-search" placeholder="Filtrer par lieu de départ">
            <div class="absolute top-3 left-3">
                <i class="fa-solid fa-magnifying-glass text-gray-400"></i>
            </div>
        </div>
        <div class="relative">
            <input class="h-12 w-80 rounded-2 outline-none pl-8 border border-[#2596be]" type="text" id="arrival-point-search" placeholder="Filtrer par lieu de d'arrivée">
            <div class="absolute top-3 left-3">
                <i class="fa-solid fa-magnifying-glass text-gray-400"></i>
            </div>
        </div>
    ...
    <div class="mt-6">
        ...
        <select id="cargo-type-search" class="bg-gray-50 border border-[#2596be] outline-none text-gray-400  rounded-2 focus:ring-blue-500 block w-fit py-3 pl-2 pr-11 ml-3 pb-4 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500">
            <option selected disabled value="">Filter par type de cargaison</option>
    ...
    <div class="ml-10 hidden mt-2">
        <label>Date départ</label>
        <input type="date" class="border pl-2 py-1 px-5 rounded-2 mt-1 border-[#2596be] outline-none" id="leaving-date-search">
    </div>
    <div class="mt-2 hidden">
        <label>Date arrivée</label>
        <input type="date" class="border pl-2 py-1 px-5 rounded-2 mt-1 border-[#2596be] outline-none" id="arrived-date-search">
    </div>
</div>
...
<dialog id="my_modal_2" class="modal">
  <div class="modal-box">
    <h3 class="font-bold text-lg">Informations de la Cargaison</h3>
...
<div class="overflow-x-auto mt-5">
    <table class="table">
        <thead class="bg-[#234664] text-white font-bold">
        <tr>
            <th></th>
        ...
        <tbody class="bg-[#2596be] text-white font-extrabold" id="tbody-cargo" id="tbody-cargo">
            ...
            <?php foreach($cargos['cargaisons'] as $c) : ?>
                ...
                <tr>
                    ...
                    <td><button type="button" class="add-product-btn" data-id="<?= $c['id'] ?>"><i class="fa-solid fa-plus"></i></button></td>
                </tr>
            <?php endforeach ?>
        </tbody>
    </table>
    <div class="flex justify-end pr-4 mt-2">
    <button id="prev-page" class="bg-[#2596be] text-white px-2 py-1 rounded" type="button"><i class="fa-solid fa-left-long"></i></button>
            <span id="page-info" class="mx-2"></span>
            <button id="next-page" class="bg-[#2596be] text-white px-2 py-1 rounded" type="button"><i class="fa-solid fa-right-long"></i></button>
    </div>
</div>
    <!-- MODAL ADD CARGO -->
        ...
        <input type="hidden" name="totalAmount" value="0">
          ...
          <div class="mt-5 flex flex-row gap-2">
            <div class="flex items-center gap-2">
                <input type="radio" name="radio-2" id="byWeight" class="radio radio-primary" checked /><label for="">Par poids Max</label>
            </div>
            <div class="flex items-center gap-2">
                <input type="radio" name="radio-2" id="byProduct" class="radio radio-primary"/>Par nombre de produits
            </div>
          </div>
          ...
          <div class="flex justify-end gap-3 mt-4">
            <button type="button" class="btn btn-error text-white" onclick="document.getElementById('my_modal_4').close()">cancel</button>
            <button class="btn bg-[#2596be] text-white">Add</button>
          </div>
    </form>
  ...
  <div class="modal-box w-11/12 max-w-5xl">
    ...
    <form id="add-product" method="POST">
        ...
        <fieldset class="border p-4 rounded mt-3">
          ...
          <div class="flex justify-end gap-3 mt-4">
            <button type="button" class="btn bg-red-500  text-white" onclick="document.getElementById('my_modal_5').close()">Cancel</button>
            <button class="btn bg-[#2596be] text-white">Add</button>
          </div>
    </form>
